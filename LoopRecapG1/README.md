...
A recap Android project that revisits and consolidates loop concepts covered in class. The app demonstrates practical use of `for` and `while` loops in a real Android context, helping to solidify understanding before moving on to multi-screen apps.
...
4. Navigate to the `LoopRecapG1` folder and click **OK**.
...
- [Kotlin Break and Continue](https://www.w3schools.com/kotlin/kotlin_break_continue.php)

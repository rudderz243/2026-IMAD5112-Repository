...
An Android app that checks whether a student has passed or failed based on a mark they enter. It introduces conditional logic using `if-else` statements in Kotlin, making decisions based on user-provided input.
...
4. Navigate to the `PassCheckerG2` folder and click **OK**.
...
- [Kotlin Booleans](https://www.w3schools.com/kotlin/kotlin_booleans.php)
- [Kotlin Comparison Operators](https://www.w3schools.com/kotlin/kotlin_operators.php)
